...
CREATE TABLE Order_Details  (book_id INT int PRIMARY KEY,quantity DOUBLE, FOREIGN KEY (order_id) REFERENCES Orders(order_id) FOREIGN KEY (book_id) REFERENCES Books(book_id));
